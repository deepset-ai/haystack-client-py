...
class DocumentApi(object):
    ...
    def delete_documents_by_filter_documents_delete_by_filters_post(
        ...
        **kwargs
        ...
        Can be used to delete documents from a document store.  :param filters: Filters to narrow down the documents to delete.                 Example: '{\"filters\": {{\"name\": [\"some\", \"more\"], \"category\": [\"only_one\"]}}'                 To delete all documents you should provide an empty dict, like:                 '{\"filters\": {}}'  # noqa: E501
    ...
    def get_documents_by_filter_documents_get_by_filters_post(
        ...
        **kwargs
        ...
        Can be used to get documents from a document store.  :param filters: Filters to narrow down the documents to delete.                 Example: '{\"filters\": {{\"name\": [\"some\", \"more\"], \"category\": [\"only_one\"]}}'                 To get all documents you should provide an empty dict, like:                 '{\"filters\": {}}'  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
